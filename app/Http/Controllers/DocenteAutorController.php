...
class DocenteAutorController extends Controller
{
    public function store(Request $request)
    {
        ...
        if ($autorExistente) {
            return redirect()->route('docentes.materials.create')->withInput()->withErrors(['autor_duplicado' => 'El autor ya existe.']);
        }
        ...
        // Redirigir a la página de materiales con un mensaje de exito
        return redirect()->route('docentes.materials.create')->withInput()->with('success', 'Autor creado exitosamente');
    }
}

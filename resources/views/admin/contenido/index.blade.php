                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingAutor{{ $autor->id }}">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseAutor{{ $autor->id }}" aria-expanded="false"
                            aria-controls="collapseAutor{{ $autor->id }}">
            ...
            @foreach ($academias as $academia)
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingAcademia{{ $academia->id }}">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseAcademia{{ $academia->id }}" aria-expanded="false"
                            aria-controls="collapseAcademia{{ $academia->id }}">
            ...
            @foreach ($asignaturas as $asignatura)
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingAsignatura{{ $asignatura->id }}">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseAsignatura{{ $asignatura->id }}" aria-expanded="false"
                            aria-controls="collapseAsignatura{{ $asignatura->id }}">
                            {{ $asignatura->nombre_asignatura }}
                        </button>
                    </h2>
                    <div id="collapseAsignatura{{ $asignatura->id }}" class="accordion-collapse collapse"
...
<div class="row mt-3">
            ...
            @foreach ($tiposContenido as $tipoContenido)
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTipoContenido{{ $tipoContenido->id }}">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseTipoContenido{{ $tipoContenido->id }}" aria-expanded="false"
                            aria-controls="collapseTipoContenido{{ $tipoContenido->id }}">
                            {{ $tipoContenido->nombre_contenido }}
                        </button>
                    </h2>
                    <div id="collapseTipoContenido{{ $tipoContenido->id }}" class="accordion-collapse collapse"
            ...
            @foreach ($docentes as $docente)
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingDocente{{ $docente->id }}">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseDocente{{ $docente->id }}" aria-expanded="false"
                            aria-controls="collapseDocente{{ $docente->id }}">
                            {{ $docente->nombre_docente }} {{ $docente->apellido_paterno }}
    ...
    <div class="col-md-4">
        <div class="accordion" id="accordionFechasPublicacion">
            <h3>Fechas de Publicación</h3>
            @foreach ($fechasPublicacion as $fecha)
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFecha{{ $fecha }}">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseFecha{{ $fecha }}" aria-expanded="false"
                            aria-controls="collapseFecha{{ $fecha }}">
                            {{ $fecha }}
                        </button>
                    </h2>
                    <div id="collapseFecha{{ $fecha }}" class="accordion-collapse collapse"

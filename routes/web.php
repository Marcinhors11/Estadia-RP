...
Route::middleware(['auth:docente'])->group(function () {
    ...
    // Rutas de autores
    Route::get('docente/autores/create', [AutorController::class, 'create'])->name('docentes.autores.create');
    Route::post('docente/autores', [AutorController::class, 'store'])->name('docentes.autores.store');
...
Route::middleware(['auth:administrador'])->group(function () {
    ...
    // Rutas de autores
    Route::get('admin/autores/create', [AutorController::class, 'create'])->name('autores.create');
    Route::post('admin/autores', [AutorController::class, 'store'])->name('autores.store');
